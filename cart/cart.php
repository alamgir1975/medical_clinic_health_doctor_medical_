						...
						<td class="product-remove-and-thumbnail">
							<?php
								...
								if ( ! $product_permalink ) {
									echo medical_clinic_return_content( $thumbnail ); // PHPCS: XSS ok.
								} else {
			...
			<tr>
				<td colspan="6" class="actions">
					...
					<?php if ( wc_coupons_enabled() ) { ?>
						<div class="coupon">
							<label for="coupon_code"><?php esc_html_e( 'Coupon', 'medical-clinic' ); ?>:</label> <input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'medical-clinic' ); ?>" /> <button type="submit" class="button" name="apply_coupon" value="<?php esc_attr_e( 'Apply Coupon', 'medical-clinic' ); ?>"><?php esc_html_e( 'Apply Coupon', 'medical-clinic' ); ?></button>
							<?php do_action( 'woocommerce_cart_coupon' ); ?>
						</div>
					<?php } ?>

					<button type="submit" class="button" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'medical-clinic' ); ?>"><?php esc_html_e( 'Update cart', 'medical-clinic' ); ?></button>
