...
echo '<div class="profile_opened_article_inner">' . "\n";
	if ($cmsmasters_option['medical-clinic' . '_profile_post_nav_box']) {
		$order_cat = (isset($cmsmasters_option['medical-clinic' . '_profile_post_nav_order_cat']) ? $cmsmasters_option['medical-clinic' . '_profile_post_nav_order_cat'] : false);
		
		medical_clinic_prev_next_posts($order_cat, 'pl-categs');
	}
