...
if ($cmsmasters_option['medical-clinic' . '_portfolio_project_nav_box']) {
	$order_cat = (isset($cmsmasters_option['medical-clinic' . '_portfolio_project_nav_order_cat']) ? $cmsmasters_option['medical-clinic' . '_portfolio_project_nav_order_cat'] : false);
	
	medical_clinic_prev_next_posts($order_cat, 'pj-categs');
}
