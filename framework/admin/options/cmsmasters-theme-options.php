...
function medical_clinic_admin_enqueue_scripts($hook) {
	if ( 
		...
		wp_localize_script('medical-clinic-options-js', 'cmsmasters_options', array( 
			...
			'want_remove' => 		esc_html__('Do you really want to remove this item?', 'medical-clinic'), 
		...
		case 'icon':
			echo '<div class="icon_management">' . 
				'<p>' . 
					...
					'<a href="#" class="cmsmasters_remove_icon admin-icon-remove' . (($meta != '') ? ' cmsmasters_dib' : '') . '" title="' . esc_attr__('Remove icon', 'medical-clinic') . '"></a>' . 
				'</p>' . 
			'</div>' . 
