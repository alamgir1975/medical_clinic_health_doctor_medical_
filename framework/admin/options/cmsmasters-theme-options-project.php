...
function medical_clinic_get_custom_project_meta_fields() {
	...
	$custom_project_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Project Puzzle Image Size', 'medical-clinic'), 
			'desc'	=> esc_html__('Recommended Project Puzzle Image dimensions, or other size, with the same ratio', 'medical-clinic') . ' - ', 
		...
		array( 
			'label'	=> esc_html__('Project Puzzle Image', 'medical-clinic'), 
			'desc'	=> esc_html__('Choose image for Masonry Puzzle portfolio projects', 'medical-clinic'), 
